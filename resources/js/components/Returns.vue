<template>
  <section class="content">
    <div class="container">
      <br />
      <h1 class="display-4">Devolução</h1>
      <br />
        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Editar status de devolução </h5>
      ...
      <b-row>
        <b-col>
          <b-input type="text" placeholder="pesquisar por numero de serie"></b-input>
        </b-col>
        <b-col cols="2">
          <b-btn v-b-modal.addReturn>Adicionar Devolução</b-btn>
       ...
       <h1 v-else>{{cartx2.length}} Item</h1> -->
            ...
            <b-btn @click="returnz()">Salvar</b-btn>
          </b-modal>
        </b-col>
      </b-row>
      <br />
            ...
            <tr :key="index" v-if="i.returnno != null">
              ...
              <td>
                ...
                <b-modal
                  ...
                  :title="'Nº de serie' + i.serialnumber"
                  size="lg"
                  centered
                  hide-footer
                >
                  <b-form-textarea
                    ...
                    max-rows="6"
                  ></b-form-textarea>
                  <b-btn @click="updateRemarks(i.id)">salvar</b-btn>
                </b-modal>
              </td>
              <td>
                <b-badge variant="primary" v-if="i.returnStatus === 'Pending' ">Pendente</b-badge>
                <b-badge variant="warning" v-if="i.returnStatus === 'Reparar' ">reparar</b-badge>
                <b-badge variant="info" v-if="i.returnStatus === 'Fixed'" >fixo</b-badge>
                <b-badge variant="success" v-if="i.returnStatus === 'Release' ">devolvido</b-badge>
              </td>
              <td>
                 <b-btn @click="editModal(i)" size="sm" variant="secondary">actualizar</b-btn>
              </td>
            </tr>
          </template>
        </tbody>
