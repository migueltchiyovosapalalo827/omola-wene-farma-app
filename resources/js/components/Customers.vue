        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode">Adicionar novo cliente</h5>
                    <h5 class="modal-title" v-show="editmode">Editar detalhes do cliente</h5>
      ...
      <b-row>
        ...
        <b-col cols="2">
          <b-btn id="addbutton" variant="outline-secondary" @click="newModal">
              <b-icon icon="plus"></b-icon> Novo Cliente
          </b-btn>
        </b-col>
      </b-row>
