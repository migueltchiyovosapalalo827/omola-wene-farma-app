        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode">Create criar nova categoria</h5>
                    <h5 class="modal-title" v-show="editmode">Actualizar Categoria</h5>
        ...
        methods: {
            ...
            createCategory(){
                ...
                .catch(()=>{
                    Toast.fire({
                        icon: 'error',
                        title: 'Ocorreu um erro! Porfavor Tenta mais Tarde'
                    });
                })
            }
