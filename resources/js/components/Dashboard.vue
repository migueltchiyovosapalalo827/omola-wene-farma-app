      ...
      <div class="row filts">
          ...
          <div class="info-box mb-3" v-b-toggle.daily>
            ...
            <div class="info-box-content">
              <span class="info-box-text"
                ><b class="space">VENDAS DIÁRIAS</b></span
              >
          ...
          >
            <b-card>
              <table class="table">
                <thead>
                  <th>
                    <small><b>ID da compra</b></small>
                  </th>
                  <th>
                    <small><b>ID do cliente</b></small>
                  </th>
                  <th>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="info-box mb-3" v-b-toggle.stocks>
            ...
            <div class="info-box-content">
              <span class="info-box-text"
                ><b class="space"> STOCKS POR CATEGORIA</b></span
              >
              <span class="info-box-number">
                <h4>
              ...
              <template #modal-footer>
                <div class="w-100">
                  <small
                    ...
                    >Há uma categoria de produto que não é usada.</small
                  >
                  <small
                    class="float-left text-muted"
                    v-if="stocksPerCategory.length < categoryLength"
                  >
                  É por isso que há {{ categoryLength }} estoques indicados, mas apenas {{ stocksPerCategory.length }} real
                  lista.</small
                  >
                </div>
              </template>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="info-box mb-3" v-b-toggle.crit>
            ...
            <div class="info-box-content">
              <span class="info-box-text"
                ><b class="space">ITENS CRÍTICOS</b></span
              >
            ...
            <b-card>
              <table class="table">
                <thead>
                  ...
                  <th class="centerx">
                    <small><b>Estoque restante</b></small>
                  </th>
                  <th class="centerx">
                    <small><b>Nível crítico</b></small>
                  </th>
                </thead>
                <tbody>
              ...
              <template #modal-footer>
                <div class="w-100">
                  <small class="float-left text-muted"
                    >Obtenha estoque adicional para os itens listados.</small
                  >
                </div>
              </template>
            </b-card>
      ...
      <div class="row filts">
        <div class="col-12 col-sm-6 col-md-4">
                    <div class="info-box mb-3" v-b-modal.totalItemSold>
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"><b class="space">ITENS VENDIDOS</b></span>
                     ...
                     <b-modal id="totalItemSold" title="Total Items Sold" header-bg-variant="light" size="xl" hide-footer hide-header>
                          <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <br>
                                    <span class="info-box-text"><h3 class="space2">ITENS COMPRADOS</h3></span>
                         ...
                         <b-card>
                            ...
                            <template #modal-footer>
                                <div class="w-100">
                                <small class="float-left text-muted">Obtenha estoque adicional para estes itens listados.</small>
                                </div>
                            </template>
                        </b-card>
                    </b-modal>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="info-box" v-b-modal.productPurchase>
            ...
            <div class="info-box-content">
              <span class="info-box-text"
                ><b class="space">RESUMO COMPRADO</b></span
              >
              <span class="info-box-number">
          ...
          <b-modal id="productPurchase" size="xl" hide-footer hide-header>
            <div class="info-box">
              ...
              <div class="info-box-content">
                <br />
                <span class="info-box-text"
                  ><h3 class="space2">ITENS VENDIDOS</h3></span
                >
              </div>
            </div>
            <b-card>
              ...
              <template #modal-footer>
                <div class="w-100">
                  <small class="float-left text-muted"
                    >Quantas vezes um produto está sendo comprado com base na data
                    faixa.</small
                  >
                </div>
              </template>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="info-box" v-b-modal.includedInPurchase>
            ...
            <div class="info-box-content">
              <span class="info-box-text"
                ><b class="space">ITENS COMPRADOS</b></span
              >
              <span class="info-box-number">
                <h4>
          ...
          >
            <div class="info-box">
              ...
              <div class="info-box-content">
                <br />
                <span class="info-box-text"
                  ><h3 class="space2">ITENS COMPRADOS</h3></span
                >
              </div>
            </div>
            <b-card>
              ...
              <table class="table" v-else>
                <thead>
                  <th>Nº</th>
                  <th>Productos</th>
                  <th>Tempos incluídos em uma compra</th>
                </thead>
                <tbody>
              ...
              <template #modal-footer>
                <div class="w-100">
                  <small class="float-left text-muted"
                    >Quantas vezes um produto incluído em uma compra.</small
                  >
                </div>
              </template>
            </b-card>
            ...
            <div class="card-body">
              <b-collapse id="collapse-1" class="mt-2">
                ...
                <div style="text-align: center">
                  <h4 style="letter-spacing: 10px">DATA</h4>
                </div>
              ...
              <table class="table">
                <thead>
                  <th class="text-muted">Nº</th>
                  <th class="text-muted">Data da transação</th>
                  <th class="text-muted" style="text-align:center">ID do Cliente</th>
                  <th class="text-muted">Valor</th>
                  <th class="text-muted">Atendido&nbsp;Por</th>
                </thead>
            ...
            <tr v-if="opened.includes(pur.ID)" :key="index" style="background-color:#f2f3f4;">
              <td colspan="5">
                ...
                <tbody v-if="filterData.length == 0" align="center">
                  ...
                  <tr>
                    <td colspan="5">
                      <h3>Nenhuma transação de compra na data/cliente selecionado</h3>
                    </td>
                  </tr>
                </tbody>
                            ...
                            <thead>
                              <tr class="noHoverEffect">
                                <!-- <th><small>CustomerID</small></th> -->
                                 ...
                                 <th>
                                  <small><b>Nome do&nbsp;cliente</b></small>
                                </th>
                                 <th>
