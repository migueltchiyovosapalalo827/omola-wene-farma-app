        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true" >
            <div class="modal-dialog modal-xl" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode">Adicionar producto</h5>
                      ...
                      >
                         <select class="form-control" v-model="form.supplier_id">
                              <option
                                  ...
                                  :value="index"
                                  :selected="index == form.supplier_id">{{ sup }}</option>
                            </select>
      ...
      <b-row>
        ...
        <b-col cols="2">
          <b-btn id="addbutton" variant="outline-secondary" @click="newModal">
              <b-icon icon="plus"></b-icon>Adicionar Novo producto</b-btn>
        </b-col>
      </b-row>
       <b-row>
        <b-col></b-col>
        ...
        methods: {
          ...
          updateProduct(){
              ...
              if(this.form.update_reason === '') {
                Swal.fire("Oops!", 'Forneça um motivo para sua atualização.', "warning");
              } else {
          ...
          loadSuppliers(){
            axios.get('api/suppliers/list').then(({ data }) => (this.suppliers = data));
          }
