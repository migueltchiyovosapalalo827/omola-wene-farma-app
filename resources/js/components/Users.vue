        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode">Criar Novo Usuario</h5>
    ...
    export default {
        ...
        methods: {
            ...
            deleteUser(id){
                Swal.fire({
                    title: 'Tens certeza ?',
                    text: "Não podera reverter esta ação!",
          ...
          createUser(){
              ...
              .catch(()=>{
                  ...
                  Toast.fire({
                      icon: 'error',
                      title: 'Ocorreu um erro ao criar o usuario!'
                  });
              })
          }
