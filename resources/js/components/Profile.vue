                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link" href="#activity" data-toggle="tab">Actividade</a></li>
                                <li class="nav-item"><a class="nav-link active show" href="#settings" data-toggle="tab">configuração</a></li>
                                <li class="nav-item"><a class="nav-link" href="#change-password" data-toggle="tab">Mudar Palavra passe</a></li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="activity">
                                    <h3 class="text-center">Exibir atividade do usuário</h3>
                                </div>
                                <!-- Setting Tab -->
                                    ...
                                    <form @click.prevent="updateInfo" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="float-right d-sm-inline text-muted">Membro desde: <span>{{form.created_at|myDate}}</span></div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="tab-pane" id="change-password">
                                    ...
                                    <div class="form-group">
                                        <label for="confirm_password" class="col-sm-2 control-label">Confirme sua senha</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button @click.prevent="updatePassword" type="submit" class="btn btn-success">Atualizar senha</button>
                                        </div>
                                    </div>
                                    </form>
                                </div>
